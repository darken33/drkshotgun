/**
 * game.js : script principal pour "Shotgun Practise"
 * 
...
function param() {
	...
	game_diff += '<option value="4" '+(game_options.difficulty == "4" ? 'selected="selected"' : '')+'>'+texte_option_diff_insane[game_options.lang]+'</option>';
